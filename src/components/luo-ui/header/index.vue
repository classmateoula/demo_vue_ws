<template>
  <div class="box ws-pr ws-sn">
    <div class="box-header border-bottom" :style="{ background, color }">
      <div class="ws-oh">
        <svg v-if="left" @click="$router.back()" t="1563099198923" class="icon ws-fl mg-l10" viewBox="0 0 1024 1024" version="1.1" p-id="1106" width=".15rem" height=".3rem"><path d="M736 960c-9 0-18.1-3.2-25-9.6L263 535.2c-13.8-12.8-13.8-33.6 0-46.4L711 73.6c13.8-12.8 36.2-12.8 50 0 13.8 12.8 13.8 33.6 0 46.4L338 512l423 392c13.8 12.8 13.8 33.6 0 46.4-6.9 6.4-16 9.6-25 9.6z" p-id="1107" fill="#2f2f36"></path></svg>
        <slot v-if="custom"></slot>
        <span v-else class="font-w ws-fl mg-l10">{{ title || $route.name }}</span>
        <svg v-if="right" @click="setShowContent" t="1563105431428" class="box-icon-right ws-fr pad-l10" viewBox="0 0 1024 1024" version="1.1" p-id="2085" width=".15rem" height=".3rem"><path d="M512 1024A512 512 0 1 1 1024 512 512 512 0 0 1 512 1024z m0-938.692923A426.692923 426.692923 0 1 0 938.692923 512 426.692923 426.692923 0 0 0 512 85.307077zM748.307692 551.384615H551.384615v196.923077a39.384615 39.384615 0 1 1-78.76923 0V551.384615H275.692308a39.384615 39.384615 0 1 1 0-78.76923H472.615385V275.692308a39.384615 39.384615 0 0 1 78.76923 0V472.615385h196.923077a39.384615 39.384615 0 0 1 0 78.76923z" p-id="2086" fill="#2f2f36"></path></svg>
        <svg v-if="search" @click="$router.push('/search')" class="box-icon-right ws-fr pad-l10" t="1563546334257" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="11594" width=".15rem" height=".3rem"><path d="M222.6944 222.7968A323.1488 323.1488 0 0 0 133.6832 512c19.2512-87.3728 64.512-172.7488 135.0144-243.3024C339.2512 198.1184 424.6272 152.8832 512 133.632c-101.632-19.1488-210.688 10.5216-289.3056 89.1648z" fill="#2f2f36" p-id="11595"></path><path d="M989.44 822.1184l-121.7024-121.7024a118.016 118.016 0 0 0-92.8-34.1248c114.4576-165.5552 97.92-394.3936-49.4848-541.824-165.9392-165.9904-435.0464-165.9904-601.0368 0-165.9392 165.9904-165.9392 435.1232 0 601.1136 147.4048 147.4304 376.064 163.84 541.7216 49.3824-2.56 33.28 8.8576 67.5328 34.1248 92.8l121.7024 121.728c46.08 45.9776 121.3696 45.9776 167.3472 0 46.208-45.9776 46.208-121.2928 0.128-167.3728zM676.096 676.096c-138.6752 138.6752-363.392 138.6752-502.016 0-138.6752-138.6752-138.6752-363.4432 0-502.1184 138.624-138.6752 363.3408-138.6752 502.016 0 138.6496 138.5728 138.6496 363.4432 0 502.1184z" fill="#2f2f36" p-id="11596"></path></svg>
        <svg v-if="more" @click="$emit('moreClick')" t="1563548345635" class="box-icon-right ws-fr pad-l10" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="13302" width=".15rem" height=".3rem"><path d="M512 512m-85.333333 0a85.333333 85.333333 0 1 0 170.666666 0 85.333333 85.333333 0 1 0-170.666666 0Z" p-id="13303" fill="#2f2f36"></path><path d="M256 512m-85.333333 0a85.333333 85.333333 0 1 0 170.666666 0 85.333333 85.333333 0 1 0-170.666666 0Z" p-id="13304" fill="#2f2f36"></path><path d="M768 512m-85.333333 0a85.333333 85.333333 0 1 0 170.666666 0 85.333333 85.333333 0 1 0-170.666666 0Z" p-id="13305" fill="#2f2f36"></path></svg>
      </div>
