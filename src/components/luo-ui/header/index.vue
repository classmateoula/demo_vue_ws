<template>
  <div class="box ws-pr ws-sn">
    <div class="box-header border-bottom" :style="{ background, color }">
      ...
      <svg v-if="right" @click="setShowContent" t="1563105431428" class="box-icon-right pad-l10" viewBox="0 0 1024 1024" version="1.1" p-id="2085" width=".15rem" height=".3rem"><path d="M512 1024A512 512 0 1 1 1024 512 512 512 0 0 1 512 1024z m0-938.692923A426.692923 426.692923 0 1 0 938.692923 512 426.692923 426.692923 0 0 0 512 85.307077zM748.307692 551.384615H551.384615v196.923077a39.384615 39.384615 0 1 1-78.76923 0V551.384615H275.692308a39.384615 39.384615 0 1 1 0-78.76923H472.615385V275.692308a39.384615 39.384615 0 0 1 78.76923 0V472.615385h196.923077a39.384615 39.384615 0 0 1 0 78.76923z" p-id="2086" fill="#2f2f36"></path></svg>
