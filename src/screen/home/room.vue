    ...
    <div class="box-body pad-n20">
      ...
      >
        <img
          ...
          :style="{ float: item.id === 1 ? 'right' : 'left' }"
        >
        <div :style="{ float: item.id === 1 ? 'right' : 'left' }">
          <img v-if="item.img" :src="item.img" alt="qwq" class="box-img">
          <div v-else :class="(item.id === 1 ? 'bg-blue' : 'bg-w') + ' pad10 radius-5'">{{ item.content }}</div>
        </div>
      </div>
    </div>
    <div class="box-bottom">
      <div class="box-bottom-fixed bg-w">
        <el-row class="pad-n5 border-bottom" type="flex" align="middle" justify="space-between">
          ...
          <el-col :span="3" class="ws-tc">
            <el-button v-if="msg" size="mini" type="success" @click="handleSubmit">确定</el-button>
...
export default {
  ...
  data () {
    return {
      ...
      dataList: [
        { id: 1, user: 'https://ss0.bdstatic.com/70cFuHSh_Q1YnxGkpoWK1HF6hhy/it/u=3271432153,1040556601&fm=26&gp=0.jpg', name: '亲生大姐就一个', content: '大家好', img: 'https://ss1.bdstatic.com/70cFvXSh_Q1YnxGkpoWK1HF6hhy/it/u=2245237821,3225377198&fm=26&gp=0.jpg' },
  ...
  methods: {
    // 发送图片
    handleChangeLook () {
      this.dataList.push({ id: 1, user: 'https://ss0.bdstatic.com/70cFuHSh_Q1YnxGkpoWK1HF6hhy/it/u=3271432153,1040556601&fm=26&gp=0.jpg', name: '亲生大姐就一个', content: this.msg, img: 'https://ss0.bdstatic.com/70cFuHSh_Q1YnxGkpoWK1HF6hhy/it/u=3271432153,1040556601&fm=26&gp=0.jpg' },)
    },
    // 发送消息
    handleSubmit () {
